...
#### 1. Intelligent RAG Agent (Gemini API Resilient Batch Pipeline)
...
#### 3. Alfred — AI Multi-Tool Assistant (LangGraph Agent)
...
#### 4. AI Capstone Project with Deep Learning
...
#### 5. Building a Regression Model in Keras
